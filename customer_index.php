	...
	<div class="header-banner">
		<div class="container">
			...
			<div class="banner-info text-center">
				<h1><a href="customer_index.php">Agriculture</a></h1>
			</div>
			...
			<div class="header-grids col-md-offset-1 text-center">
				
				<div class="header-bottom-grid2 col-md-offset-4 ">
					<span class="glyphicon glyphicon-shopping-cart"></span>
					<h4><a href="buy_crops.php" style="color:white;">Buy Crops</a></h4>
				</div>
	...
	<div class="footer">
		<div class="container">
			<div class="copyright text-center">
				<p>&copy; 2024 Agriculture Platform. All rights reserved | Design by NHZP > </a></p>
			</div>
		</div>
	</div>
	<!-- footer-section -->
