...
<body>
    ...
    <!-- <?php
      //  $url='http://newsapi.org/v2/everything?country=in&apiKey=7f1acd4f4d344efe9d732df03ab86c97';
        $url='https://newsapi.org/v2/everything?q=farmers&apiKey=b74fc3e0c29f4479ab6b420365113fac';   // API KEY
    ...
    if ($response === false) {
        ...
        // Handle error, such as logging or showing a user-friendly message.
    } else {
        $newsdata = json_decode($response);
	...
	<div class="footer">
		<div class="container">
			<div class="copyright text-center">
				<p>&copy; 2024 Agricutlure Platform. All rights reserved | Design by Rishi </a></p>
			</div>
		</div>
	</div>
	<!-- footer-section -->
